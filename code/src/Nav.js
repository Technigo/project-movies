...
export const Nav = () => {
  return (
    <nav>
      ...
      <a className="tmdb-nav-text" href="https://www.themoviedb.org/" target="_blank" rel="noopener noreferrer"><span className="nav-emoji-tablet" role="img" aria-label="movies emoji">&#127910;</span>Visit The Movie Database!</a>
    </nav>
  )
};