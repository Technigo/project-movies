  ...
  return (
    <section className="detail-section">        
      ...
      <div className="details-info">
          <img className="poster" src={`https://image.tmdb.org/t/p/w342${movies.poster_path}`} alt={movies.original_title}/>
          <div className="titel-rating-text">
            <h1>{movies.original_title}</h1>
            <span className="rating">Rating: {movies.vote_average}/10</span>
            <p>{movies.overview}</p>
          </div>
      </div>
    </section>
