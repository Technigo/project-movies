...
export const CAST_URL = (path) => `https://api.themoviedb.org/3/movie/${path}/credits?api_key=4e4121b9dfc8f7526d534df6b657c5f5&language=en-US`
export const PROFILE_URL = (path) => `https://image.tmdb.org/t/p/w185${path}`