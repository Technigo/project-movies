...
export const UPCOMING_URL = 'https://api.themoviedb.org/3/movie/upcoming?api_key=86e13ee94ff829d42c804ae17826dc54&language=en-US&page=1&region=SE'
export const UPCOMING_DETAILS_URL = (id) => `https://api.themoviedb.org/3/movie/${id}?api_key=86e13ee94ff829d42c804ae17826dc54&language=en-US`;
