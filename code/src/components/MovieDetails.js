...
export const MovieDetails = () => {
  ...
  return (
    <section className="all-movies " key={movie.id} style={{backgroundImage:`url('https://image.tmdb.org/t/p/w1280/${movie.backdrop_path}')`}}>
      <div className="background-linear-gradient">
        ...
        <div className="single-movie">
          ...
          <div className="overview">
            ...
            <h3><span className="voted-stars" role="img" aria-label="star">⭐️</span>
            <span className="voted">{movie.vote_average}/10
            </span></h3>
