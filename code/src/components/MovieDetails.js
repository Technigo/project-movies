  ...
  return (
    <article className='container'>
      ...
      <div
        ...
        style={{
          backgroundImage: `
			linear-gradient(180deg, rgba(0,0,0,0) 70%, rgba(0,0,0,1) 100%), url(${
        movie.backdrop_path ? `${imageUrl}w1280${movie.backdrop_path}` : ''
      })`,
        }}
      >
        <BackButton to='/'>
        ...
        <div className='details-container'>
          <img
            ...
            alt={movie.title}
            src={movie.poster_path ? `${imageUrl}w342${movie.poster_path}` : ''}
          />
