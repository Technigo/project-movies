      ...
      {movie && (
        <div
          ...
          <div className="details-wrapper">
            <img className="movie-poster-details" style={{ border: '5px solid white', marginTop: '80px', width: '70%' }} src={`https://image.tmdb.org/t/p/original${movie.poster_path}`} alt={movie.title} />
            <div
