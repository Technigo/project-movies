...
const Details = () => {
  ...
  return (
    <div className="backdrop-overlay">
      <img className="backdrop" src={`https://image.tmdb.org/t/p/w1280${movieDetail.backdrop_path}`} alt={movieDetail.title} />
      ...
      <div className="movie-details-container">
        <div className="poster-rating-container">
          <img className="poster" src={`https://image.tmdb.org/t/p/w342/${movieDetail.poster_path}`} alt={movieDetail.title} />
