...
const onPreviousPageRedirect = () => {
    ...
    return <NoTFoundContainer> 
            ...
            <HomePageBtn onClick={onHomePageRedirect}> Back to home page </HomePageBtn>
            < PreviousPageBtn onClick={onPreviousPageRedirect}> Back to previous page </ PreviousPageBtn >
        </NoTFoundContainer>
}
