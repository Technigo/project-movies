...
export const MovieDetails = () => {
  ...
  return (
    ...
    <div className="backDrop" style={{ backgroundImage: `url(https://image.tmdb.org/t/p/w1280${movies.backdrop_path})` }} alt={"movie.original_title"}>
      ...
      <div className="detailWrapper">
        ...
        <div className="detailsInfo">
          <h2>{movies.original_title}&nbsp;&nbsp;&nbsp;<span className="vote">{movies.vote_average}/10</span></h2>
          <p>{movies.overview}</p>
        </div>
      </div>
