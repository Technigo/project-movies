...
export const MovieInfo = () => {
  ...
  return (
    <article className="info-container" style={
      {backgroundImage: `linear-gradient(to bottom, rgba(0,0,0,0), rgba(0,0,0,1)), url(https://image.tmdb.org/t/p/w1280${info.backdrop_path})`}
      }>
      <div className="poster-container">
        <Link className="back-big-screen" to="/"><BackIcon /><h5>Movies</h5></Link>
