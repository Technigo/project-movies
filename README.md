A multi-page Movies site built in React, showing the upcoming movies displayed on one page, with links to a second page with details about the movie, fetched from the themoviedb.org.
